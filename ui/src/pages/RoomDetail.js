...
import { useParams, Link } from "react-router-dom"; // Thêm Link để tạo đường dẫn
        ...
        <div className="room-detail-container">
          <div className="room-detail">
            ...
            <div className="room-info">
              ...
              <p className="description">{room.FullDescription}</p>
              ...
              <div className="room-details-grid">
                ...
                <div className="room-detail-row">
                  ...
                  <span className="detail-value">{room.BedType || "Not specified"}</span>
                </div>
                <div className="room-detail-row">
                  <span className="detail-label">Max Occupancy</span>
                  <span className="detail-value">{room.MaxOccupancy || "N/A"} people</span>
                </div>
                <div className="room-detail-row">
                ...
                <div className="room-detail-row">
                  ...
                  <span className="detail-value">{room.CancellationPolicy || "Flexible cancellation"}</span>
                </div>
              </div>
